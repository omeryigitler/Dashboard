import { RotateCw, ClipboardList, Search, User, Phone, Mail } from 'lucide-react';
    ...
    >
      ...
      <div className="px-6 pb-3">
        <div className="flex items-center justify-center gap-2">
          ...
          <span className="text-[10px] font-bold tracking-widest text-gray-400 uppercase">Today</span>
          <div className="flex-1 h-[1px] bg-gray-200/60"></div>
        </div>
      </div>
        ...
        {WORK_ITEMS.map((item, idx) => {
          ...
          return (
            <div key={item.id} className="flex flex-col gap-1.5">
              {/* Conditional timeline separator if index is 3 (Wyatt Wetmore is older) */}
              {idx === 3 && (
